...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'teleop_twiststamped_keyboard = turtlebot3_teleop.script.teleop_twiststamped_keyboard:main',
            'collision_safety = turtlebot3_teleop.script.collision_safety:main'
        ],
    },
)
